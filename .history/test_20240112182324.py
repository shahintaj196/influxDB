...
IC.write_data(["MSFT,stock=MSFT Open=63.79,High=73.84,Low=62.13"])
IC.write_data(["MSFT,stock=MSFT Open=64.79,High=83.84,Low=62.13"])
IC.write_data(["MSFT,stock=MSFT Open=65.79,High=63.84,Low=62.13"])
IC.write_data(["MSFT,stock=MSFT Open=66.79,High=63.84,Low=62.13"])
IC.write_data(["MSFT,stock=MSFT Open=67.79,High=63.84,Low=62.13"])

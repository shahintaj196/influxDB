...
# IC.write_data(["MSFT,stock=MSFT Open=65.79,High=93.84,Low=62.13"])
# IC.write_data(["MSFT,stock=MSFT Open=66.79,High=89.84,Low=62.13"])
# IC.write_data(["MSFT,stock=MSFT Open=67.79,High=89.84,Low=62.13"])
